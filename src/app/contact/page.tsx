...
import { FaLocationDot, FaEnvelope, FaPhone,
    FaFacebookF,
    FaTwitter,
    FaLinkedinIn,
    FaYoutube,
      ...
      <div className="bg-white text-gray-800">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-start">
            {/* Section 1: Send us a message (Contact Form - Client Component) */}
            ...
            {/* Section 2: Get in touch (Static Contact Info) */}
            <div className="bg-white p-6 md:p-8 rounded-lg shadow-lg">
              ...
              <div className="space-y-6">
                {/* Location */}
                <div className="flex items-start gap-5"> {/* Increased gap for more space */}
                  <FaLocationDot className="text-[#011F4B] text-3xl mt-1 flex-shrink-0" /> {/* Larger icon, used specific color */}
                  <div>
                    <h3 className="font-semibold text-lg text-gray-800">Our Location</h3> {/* More descriptive heading */}
                    <address className="not-italic text-gray-700 leading-relaxed"> {/* Semantic HTML for address */}
