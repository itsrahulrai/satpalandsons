...
interface Props {
  PolycarbonateSheet: PolycarbonateSheet[];
}

const PolycarbonateSheet: React.FC<Props> = ({ PolycarbonateSheet }) => {
  return (
    <div className="bg-[#fff1f7] w-full  mx-auto mt-10 mb-10 py-10 px-10 rounded-xl shadow-md">
      <p className="text-base font-bold text-[#1A3C6B] tracking-wide mb-2">
        Premium Polycarbonate Sheet
      </p>
  ...
  <div className="w-full sm:w-auto">
    <button className="group w-full sm:w-auto inline-flex items-center justify-center gap-2 text-sm sm:text-base font-semibold text-white bg-[#1A3C6B] px-4 sm:px-5 py-2 rounded shadow-md hover:bg-[#163153] transition duration-300">
      View All
      <svg
...
export default PolycarbonateSheet;
