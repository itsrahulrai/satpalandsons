...
interface Props {
  crsteelSheet: crsteelSheet[];
}

const CrSteel: React.FC<Props> = ({ crsteelSheet }) => {
  return (
    <div className="bg-[#f5f5f5] w-full  mx-auto mt-10 mb-10 py-10 px-10 rounded-xl shadow-md">
