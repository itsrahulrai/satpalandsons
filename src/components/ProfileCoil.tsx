...
interface Props {
  profilecoilSheet: ProfileCoilItem[];
}

const ProfileCoil: React.FC<Props> = ({ profilecoilSheet }) => {
  return (
    <div className="bg-[#e4fafe] w-full  mx-auto mt-10 mb-10 py-10 px-10 rounded-xl shadow-md">
      <p className="text-base font-bold text-[#1A3C6B] tracking-wide mb-2">
        Premium Profile Coils
      </p>
