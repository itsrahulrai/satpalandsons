...
interface Props {
  roofingSheet: RoofingSheet[];
}

const RoofingSheets: React.FC<Props> = ({ roofingSheet }) => {
  return (
    <div className="bg-[#e9f7f1] w-full mx-auto  mb-10 py-10 px-10 rounded-xl shadow-md">
      {/* Header Row */}
      <p className="text-base font-bold text-[#1A3C6B] tracking-wide mb-2">
        Trusted Quality. Diverse Selection.
      </p>
