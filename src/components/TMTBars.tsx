...
interface Props {
  tmtbarsSheet: tmtbarsSheet[];
}

const TMTBars: React.FC<Props> = ({ tmtbarsSheet }) => {
  return (
    <div className="bg-[#f0f3ff] w-full  mx-auto mt-10 mb-10 py-10 px-10 rounded-xl shadow-md">
